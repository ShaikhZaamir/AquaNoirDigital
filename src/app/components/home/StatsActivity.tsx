...
//     return (
//         <section ref={sectionRef} className="w-full bg-[#111111] text-white">
//             <div className="flex w-full items-start">
...
//                                     }
//                                 }}
//                                 className="flex min-h-screen w-full flex-col justify-start border-b border-white/10 px-5 py-16 sm:px-8 lg:px-5 lg:py-20"
//                             >
//                                 <div className="flex flex-col">
//                                     <span
//                                         data-stat-top
...
//                                     }
//                                 }}
//                                 className="flex min-h-screen w-full flex-col justify-start border-white/10 px-5 py-16 sm:px-8 lg:px-5 lg:py-20"
//                             >
//                                 <div className="flex flex-col">
//                                     <span
//                                         data-stat-top
