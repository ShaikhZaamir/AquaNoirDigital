...
//                                     handleMouseLeave(index)
//                                 }
//                                 className="flex w-full items-start overflow-hidden border-t border-white/10 py-2"
//                             >
//                                 {/* Number */}
//                                 <div className="w-[18%] shrink-0">
//                                     <span className="text-[18px] leading-none text-white/60">
...
//                                         src={service.image}
//                                         alt=""
//                                         className="h-[90px] w-full rounded-[16px] object-cover"
//                                     />
//                                 </div>
//                             </div>
//                         ))}
...
//                                     handleMouseLeave(index)
//                                 }
//                                 className="flex min-h-[134px] w-full items-start overflow-hidden border-t border-white/10 py-5"
//                             >
//                                 {/* Number */}
//                                 <div className="w-[18%] shrink-0">
//                                     <span className="text-[18px] leading-none text-white/60">
