...
//                                 }
//                                 className="flex h-[120px] min-h-[100px] w-full items-start overflow-hidden border-t border-white/10 pt-1"
//                             >
//                                 {/* Number */}
...
//                                     <p
//                                         data-service-description
//                                         className="mt-3 max-w-[450px] translate-y-5 text-[20px] leading-[1.2] tracking-[-0.025em] opacity-0"
//                                     >
//                                         {service.description}
//                                     </p>
//                                 </div>
